...
namespace EMEDS_Project.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            // Get prescriptions uploaded by current customer
            var prescriptions =
                _prescriptionRepo.GetPrescriptionsByUserId(userId);

            // Send only prescriptions related to this order
            ViewBag.OrderPrescriptions = prescriptions
        ...
        public IActionResult CancelOrder(int orderId)
        {
            ...
            // Delivered or already cancelled orders
            // cannot be cancelled
        ...
        {
            var order =
                _orderRepo.GetOrderWithItems(id);
